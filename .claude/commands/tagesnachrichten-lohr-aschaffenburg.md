...
Erste Runde (parallel): Blaulicht meine-news.de (MS+AB+MIL) + aschaffenburg.news/aktuelles.html + infranken.de (AB+MS)
...
- Header: `[Wochentag], [Datum] · [HH:MM] Uhr CEST · Nachrichten – Lohr am Main & Aschaffenburg`
- Logo: `<img src="file_000000002f8872469668704c39f1eaf6.jpg">` | Favicon: `favicon.ico` (gleiches Verz.)
- Wetter-Box: 24h scrollbar + 2-Tage-Karten
...
- Newsletter: E-Mail-Formular (gut sichtbar), POST zu PHP-Handler, speichert in `email_list.md` (eine E-Mail pro Zeile)
